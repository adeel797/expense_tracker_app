...
@GenerateMocks(
  ...
  customMocks: [
    ...
    MockSpec<CloudSyncService>(onMissingStub: OnMissingStub.returnDefault),
...
void registerServices() {
  ...
  getAndRegisterCloudSyncService();
...
MockCloudSyncService getAndRegisterCloudSyncService() {
  _removeRegistrationIfExists<CloudSyncService>();
  final service = MockCloudSyncService();
  locator.registerSingleton<CloudSyncService>(service);
  return service;
}
